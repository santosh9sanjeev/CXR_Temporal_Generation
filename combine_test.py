...
file_list = [
    '/nfs/users/ext_ibrahim.almakky/Santosh/CVPR/temporal_project/trained_models/exp-8/cuda:0_test_output_epoch=06_2_of_2_test_main_file_v2.pt',
    '/nfs/users/ext_ibrahim.almakky/Santosh/CVPR/temporal_project/trained_models/exp-8/cuda:1_test_output_epoch=06_2_of_2_test_main_file_v2.pt',
    '/nfs/users/ext_ibrahim.almakky/Santosh/CVPR/temporal_project/trained_models/exp-8/cuda:2_test_output_epoch=06_2_of_2_test_main_file_v2.pt',
    '/nfs/users/ext_ibrahim.almakky/Santosh/CVPR/temporal_project/trained_models/exp-8/cuda:3_test_output_epoch=06_2_of_2_test_main_file_v2.pt',
    '/nfs/users/ext_ibrahim.almakky/Santosh/CVPR/temporal_project/trained_models/exp-8/cuda:4_test_output_epoch=06_2_of_2_test_main_file_v2.pt',
    '/nfs/users/ext_ibrahim.almakky/Santosh/CVPR/temporal_project/trained_models/exp-8/cuda:5_test_output_epoch=06_2_of_2_test_main_file_v2.pt',
]
...
torch.save(list_pt_files, '/nfs/users/ext_ibrahim.almakky/Santosh/CVPR/temporal_project/trained_models/exp-8/test_output_epoch=06_2_of_2_test_main_file_v2.pt')

ckpt_path = '/nfs/users/ext_ibrahim.almakky/Santosh/CVPR/temporal_project/trained_models/exp-8/test_output_epoch=06_2_of_2_test_main_file_v2.pt'
# gathered_test_step_outputs = # GATHER FROM SOMEWHERE
# max_img_num = # DEFINE HERE
save_dir = '/nfs/users/ext_ibrahim.almakky/Santosh/CVPR/temporal_project/trained_models/exp-8'
