...
file_list = [
    '/nfs/users/ext_ibrahim.almakky/Santosh/CVPR/temporal_project/trained_models/exp-6-CXRBERT_wo_token/cuda:0_test_output_epoch=72_1_of_1_test_main_file_v2.pt',
    '/nfs/users/ext_ibrahim.almakky/Santosh/CVPR/temporal_project/trained_models/exp-6-CXRBERT_wo_token/cuda:1_test_output_epoch=72_1_of_1_test_main_file_v2.pt',
    '/nfs/users/ext_ibrahim.almakky/Santosh/CVPR/temporal_project/trained_models/exp-6-CXRBERT_wo_token/cuda:2_test_output_epoch=72_1_of_1_test_main_file_v2.pt',
    '/nfs/users/ext_ibrahim.almakky/Santosh/CVPR/temporal_project/trained_models/exp-6-CXRBERT_wo_token/cuda:3_test_output_epoch=72_1_of_1_test_main_file_v2.pt',
    '/nfs/users/ext_ibrahim.almakky/Santosh/CVPR/temporal_project/trained_models/exp-6-CXRBERT_wo_token/cuda:4_test_output_epoch=72_1_of_1_test_main_file_v2.pt',
    '/nfs/users/ext_ibrahim.almakky/Santosh/CVPR/temporal_project/trained_models/exp-6-CXRBERT_wo_token/cuda:5_test_output_epoch=72_1_of_1_test_main_file_v2.pt',
]
...
torch.save(list_pt_files, '/nfs/users/ext_ibrahim.almakky/Santosh/CVPR/temporal_project/trained_models/exp-6-CXRBERT_wo_token/test_output_epoch=72_1_of_1_test_main_file_v2.pt')

ckpt_path = '/nfs/users/ext_ibrahim.almakky/Santosh/CVPR/temporal_project/trained_models/exp-6-CXRBERT_wo_token/test_output_epoch=72_1_of_1_test_main_file_v2.pt'
